...
<div className="content-container">
  <div className="left-content">
    <img id="img1" className="imageToShow" src="https://placekitten.com/300/700?image=1" alt="kitty" />
    <img id="img2" className="imageToShow" src="https://placekitten.com/300/700?image=2" alt="kitty" />
    <blockquote id="text1" className="textToShow" cite="https://www.youtube.com/watch?v=PKffm2uI4dk">
      <p>Cat ipsum dolor sit amet, attack the child i show my fluffy belly but its a trap!</p>
      <footer>— Fluffy, the kitten <cite>Sad Cat Diary</cite></footer>
    </blockquote>
    <img id="img3" className="imageToShow" src="https://placekitten.com/300/700?image=3" alt="kitty" />
  </div>
  
  <div className="right-content">
    <p className="contentMarker" data-marker-content="img1">Cat ipsum dolor sit amet, attack the child i show my fluffy belly but its a trap!</p>
    ...
    <p>When owners are asleep, cry for no apparent reason love you, then bite you push your water glass on the floor or swipe at owners legs and toy mouse squeak roll over. Cough furball into food bowl then scratch owner for a new one. Damn that dog cat walks in keyboard so hide at bottom of staircase to trip human flee in terror at cucumber discovered on floor.</p>
      
    <p>Meow and walk away meow for food, then when human fills food dish, take a few bites of food and continue meowing scream at teh bath and the door is opening! how exciting oh, its you, meh so brown cats with pink ears hey! you there, with the hands but fight an alligator and win. Use lap as chair howl on top of tall thing be a nyan cat, feel great about it, be annoying 24/7 poop rainbows in litter box all day, chirp at birds leave fur on owners clothes, scratch at the door then walk away.</p>

    <p>Catasstrophe i’m so hungry i’m so hungry but ew not for that so run in circles, or i like fish. Making sure that fluff gets into the owners eyes knock dish off table head butt cant eat out of my own dish i could pee on this if i had the energy meow meow we are 3 small kittens sleeping most of our time, we are around 15 weeks old i think, i don’t know i can’t count.</p>
    
    <p>Grass smells good the fat cat sat on the mat bat away with paws theres a forty year old lady there let us feast. Throwup on your pillow more napping, more napping all the napping is exhausting, sniff catnip and act crazy. Trip owner up in kitchen i want food. I bet my nine lives on you-oooo-ooo-hooo. Pee in humans bed until he cleans the litter box. Stare at owner accusingly then wink push your water glass on the floor making sure that fluff gets into the owners eyes. Cry louder at reflection destroy couch as revenge lick sellotape really likes hummus for rub my belly hiss.</p>
    
    <p className="contentMarker" data-marker-content="text1">Jump launch to pounce upon little yarn mouse, bare fangs at toy run hide in litter box until treats are fed chase laser or roll on the floor purring your whiskers off for pretend you want to go out but then dont play time. Munch, munch, chomp, chomp pooping rainbow while flying in a toasted bread costume in space you call this cat food sleep on my humans head but meow to be let in rub face on owner.</p>
    
    <p>Eat half my food and ask for more hell is other people cough furball into food bowl then scratch owner for a new one, lick human with sandpaper tongue yet im bored inside, let me out im lonely outside, let me in i cant make up my mind whether to go in or out, guess ill just stand partway in and partway out, contemplating the universe for half an hour how dare you nudge me with your foot?!?! leap into the air in greatest offense!</p>
    ...
    <p>Cats secretly make all the worlds muffins sit on the laptop but toy mouse squeak roll over, or its 3am, time to create some chaos or look at dog hiiiiiisssss.</p>
    
    <p>Meow and walk away. Scratch the postman wake up lick paw wake up owner meow meow. Loves cheeseburgers freak human out make funny noise mow mow mow mow mow mow success now attack human, chase the pig around the house catching very fast laser pointer making sure that fluff gets into the owners eyes, but crusty butthole yet get scared by doggo also cucumerro.</p>
    
    <p>Gnaw the corn cob sniff other cats butt and hang jaw half open thereafter toy mouse squeak roll over throw down all the stuff in the kitchen. Destroy couch lick butt.</p>
    ...
    <p>Kick up litter instantly break out into full speed gallop across the house for no reason so i bet my nine lives on you-oooo-ooo-hooo as lick i the shoes lay on arms while youre using the keyboard or my slave human didnt give me any food so i pooped on the floor.</p>
    
    <p>Lick butt and make a weird face catch mouse and gave it as a present so i do no work yet get food, shelter, and lots of stuff just like man who lives with us ignore the squirrels, youll never catch them anyway bite off humans toes but climb leg, lick the curtain just to be annoying.</p>
    
    <p>Soft kitty warm kitty little ball of furr my water bowl is clean and freshly replenished, so ill drink from the toilet, find something else more interesting, or cat jumps and falls onto the couch purrs and wakes up in a new dimension filled with kitty litter meow meow yummy there is a bunch of cats hanging around eating catnip , but cat mojo but man running from cops stops to pet cats, goes to jail so stand with legs in litter box, but poop outside.</p>
    
    <p>Step on your keyboard while youre gaming and then turn in a circle behind the couch. Gate keepers of hell give attitude, for jump five feet high and sideways when a shadow moves. Bird bird bird bird bird bird human why take bird out i could have eaten that sit on human they not getting up ever.</p>
...
<h1 className="header-section">How do you like the effect?</h1>
