...
export default function halfBannercircle() {
   return (
<div class="w-full h-screen p-4 flex justify-center items-center">
    <div class="w-full md:w-5/6 xl:w-4/6 h-9/10 flex items-center bg-gray-100 rounded-lg font-mono">
        <div class="w-full sm:w-1/2 md:w-1/3 p-10 grid grid-cols-1 space-y-4">
            ...
            <div class="space-y-2">
                <input class="w-full rounded-md" type="text" placeholder="Username"/>
                <input class="w-full rounded-md" type="password" placeholder="Password"/>
                <button class="w-full focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-purple-500 hover:bg-purple-600 hover:shadow-lg">Login</button>
            </div>
            <a href="#" class="flex justify-around">
        ...
        <div class="hidden sm:inline sm:w-1/2 md:w-2/3 p-10 md:p-20">
            <svg id="f795efda-d52b-464f-8ed0-c83c27181fc6" 
            data-name="Layer 1" 
            xmlns="http://www.w3.org/2000/svg" 
            xmlnsXlink="http://www.w3.org/1999/xlink" 
            width="754" height="750.35999" viewBox="0 0 754 750.35999">
                <defs><linearGradient id="b13d5aa8-7d59-4aa5-8b0c-a1087af90b05" 
                x1="632.9307" y1="457.00246" x2="719.74066" y2="457.00246" 
                gradientUnits="userSpaceOnUse"><stop offset="0" 
                stop-color="#fff"/><stop offset="1" stop-color="#fff" 
                stop-opacity="0.3"/>
                </linearGradient><linearGradient 
                id="b216fe78-eea0-4fe3-b1f5-9d415c27bb0d" x1="578.9307" 
                y1="243.00246" x2="665.74066" y2="243.00246" 
                ...
                <rect x="386.81" y="336.40997" width="34.09998" 
                height="413.54004" fill="#2f2e41"/>
