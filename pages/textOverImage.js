...
{{ /*   REFERENCE : https://codesandbox.io/s/smooth-scroll-wjip5?file=/src/styles.css:0-4096  https://github.com/codrops/SmoothScrollingImageEffects/ */}}
      ...
      <div data-scroll className="page page--layout-2">
				...
				<div className="content content--full content--alternate">
					...
					<div className="content__item content__item--wide">
						...
						<div className="content__item-imgwrap"><div className="content__item-img" style={{backgroundImage: " url(img/21.jpg);"}}>    <Image src={require('/assets/sanfrancisco.webp')}  alt="image" /></div></div>
						<div className="content__item-deco"></div>
					...
					<div className="content__item content__item--wide">
						...
						<div className="content__item-imgwrap"><div className="content__item-img" style={{backgroundImage: " url(img/19.jpg);"}}>    <Image src={require('/assets/austin.webp')}  alt="image" /></div></div>
						<div className="content__item-deco"></div>
					...
					<div className="content__item content__item--wide">
						...
						<div className="content__item-imgwrap"><div className="content__item-img" style={{backgroundImage: " url(img/20.jpg);"}}>    <Image src={require('/assets/dallas.webp')}  alt="image" /></div></div>
						<div className="content__item-deco"></div>
					...
					<div className="content__item content__item--wide">
						...
						<div className="content__item-imgwrap"><div className="content__item-img" style={{backgroundImage: " url(img/18.jpg);"}}>    <Image src={require('/assets/sanfrancisco.webp')}  alt="image" /></div></div>
						<div className="content__item-deco"></div>
					...
					<div className="content__item content__item--wide">
						...
						<div className="content__item-imgwrap"><div className="content__item-img" style={{backgroundImage: " url(img/16.jpg);"}}>    <Image src={require('/assets/dallas.webp')}  alt="image" /></div></div>
						<div className="content__item-deco"></div>
					...
					<div className="content__item content__item--wide">
						...
						<div className="content__item-imgwrap"><div className="content__item-img" style={{backgroundImage: " url(img/11.jpg);"}}>    <Image src={require('/assets/sanfrancisco.webp')}  alt="image" /></div></div>
						<div className="content__item-deco"></div>
