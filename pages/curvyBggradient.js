...
return (
<div> 
<div class="bg-cover bg-center absolute z-0 h-screen bg-no-repeat" style={{backgroundImage:"url('http://preview.uxtheme.website/xpider-preview/xpider/img/hero-8.png')"}}></div>
    ...
    <div class="absolute w-full flex flex-col">
        <div class="bg-bottom bg-no-repeat bg-cover" style={{backgroundImage:"url('https://galaxy.up.video/media/backgrounds/bg-curve.svg')"}}>
            <header class="z-20 w-full xl:px-0 px-2">
                <div class="container mx-auto flex flex-wrap mt-8 mb-8 ">
                    <div class="flex sm:w-1/2 flex">
                        <svg version="1.1" id="isologo" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             width="40px" height="40px" viewBox="0 0 399.998 399.997" style={{enableBackground:"new 0 0 399.998 399.997;"}}
                             >
                        ...
                        <a href="/" class="text-2xl text-white ml-1 font-bold">My Company</a>
                    </div>
                    <div class="w-1/2 hidden sm:flex justify-end">
                        <button class="border border-white bg-transparent text-white uppercase rounded-full py-2 px-4 hover:bg-blue-600">Get Started Now</button>
                    </div>
                </div>
            </header>
            <section class="w-full">
                <div class="container mx-auto flex flex-row sm:items-center xl:pb-16 xl:px-0 px-4">
                    <div class="w-1/2 text-white flex flex-col">
                        <h1 class="sm:text-5xl text-xl font-weight-bolder sm:mb-4">Best app landin page for Apps Downloads.</h1>
                        <h2 class="sm:text-2xl text-base mb-2">Tailwind landing app theme.</h2>
                        <p class="text-xs sm:text-base">This is your text under h1 and h2. Write your main text promotional here.</p>
                        <form class="xl:mt-4 mt-8 flex hidden xl:flex">
                            <input class="rounded-l-full p-4 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white" placeholder="your@mail.com"/>
                            <button class="px-8 rounded-r-full bg-yellow-400  text-gray-800 font-bold p-4 uppercase border-yellow-500 border-t border-b border-r">Subscribe</button>
                        </form>
                        <p class="text-xs sm:block hidden">* Legal text</p>
                    </div>
                    <div class="w-1/2 xl:pt-8 xl:items-center flex justify-end">
                        <img class="xl:w-3/5" src="http://preview.uxtheme.website/xpider-preview/xpider/img/mobile-4.png" alt="Mobile phone"/>
                    </div>
                </div>
            </section>
        </div>
                    ...
                    <div class="sm:w-1/3 mb-8 sm:mb-0 xl:pr-0 pr-2">
                        <div class="flex flex-wrap mb-4">
                            <div class="w-1/6 items-center mx-auto">
                                <svg height="40px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 58.201 58.201" 
                                style={{enableBackground:"new 0 0 58.201 58.201;"}} >
                            ...
                            <div class="w-5/6"><h4 class="text-black items-center xl:text-2xl">One Platform</h4></div>
                        </div>
                        <p><b class="font-normal text-blue-600">No more Mulitple Platforms.</b> Now it had see nunable uneasy. Drawings can followed by improved out sociable not. Earnestly so do instantly pretended.</p>
                    </div>
                    <div class="sm:w-1/3 mb-8 sm:mb-0 xl:pr-0 pr-2">
                        <div class="flex flex-wrap mb-4">
                            <div class="w-1/6 items-center mx-auto">
                                <svg height="40px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                     viewBox="0 0 55 55" style={{enableBackground:"new 0 0 55 55;"}} >
                            ...
                            <div class="w-4/5"><h4 class="text-black items-center xl:text-2xl">Communication</h4></div>
                        </div>
                        <p><b class="font-normal text-blue-600">No more Mulitple Platforms.</b> Now it had see nunable uneasy. Drawings can followed by improved out sociable not. Earnestly so do instantly pretended.</p>
                    </div>
                    <div class="sm:w-1/3 mb-8 sm:mb-0 xl:pr-0 pr-2">
                        <div class="flex flex-wrap mb-4">
                            ...
                            <div class="w-4/5"><h4 class="text-black items-center xl:text-2xl">Project Management</h4></div>
                        </div>
                        <p><b class="font-normal text-blue-600">No more Mulitple Platforms.</b> Now it had see nunable uneasy. Drawings can followed by improved out sociable not. Earnestly so do instantly pretended.</p>
                    </div>
                </div>
        ...
        <footer class="container text-center pb-8 border-t border-gray-200 pt-8 text-xs text-gray-700">
            <div>Template inspired in: <a class="text-orange-600" href="http://preview.uxtheme.website/xpider-preview/xpider/home-adelaide.html">xPider theme</a></div>
        </footer>
    </div>
  </div>
