...
export default function Navvie() {
              ...
              <div class="flex flex-col flex-wrap p-5 mx-auto md:items-center md:flex-row">
                ...
                <a href="/" class="justify-center focus:outline-none md:ml-auto md:mr-auto">
                  <div class="inline-flex items-center">
                    ...
                    <h2 class="block p-2 text-xl font-medium tracking-tighter text-black transition duration-500 ease-in-out transform cursor-pointer hover:text-blueGray-500 lg:text-x lg:mr-8"> Kappytoes </h2>
                  </div>
                </a>
                <button class="w-auto px-8 py-2 my-2 text-base font-medium text-white transition duration-500 ease-in-out transform bg-blue-600 border-blue-600 rounded-md lg:ml-auto focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:b-gblue-700 ">Button </button>
              </div>
            </div>
          </div>
